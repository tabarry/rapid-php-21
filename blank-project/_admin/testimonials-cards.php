                        ...
                        <div class="page-content">
                            ...
                            <div class="single-head">
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo ADMIN_URL; ?>testimonials/"><i class="fa fa-table"></i></a>
                                </div>
                                ...
                                <form class="form-horizontal" name="searchForm" id="searchForm" method="get" action="">
                                    <fieldset id="search-area1">
                                        ...
                                        <?php if ($_GET['q']) { ?>
                                            ...
                                            <div class="pull-right"><a style="text-decoration:underline !important;" href="<?php echo ADMIN_URL; ?>testimonials-cards/">Clear search.</a></div>
                                            </div>
                                        <?php } ?>
                                    </fieldset>
                                </form>
                                            ...
                                            <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE)) { ?>
                                                ...
                                                <header>
                                                    <?php if ($editAccess == TRUE) { ?>
                                                        ...
                                                        <a href="<?php echo ADMIN_URL; ?>testimonials-update/<?php echo $row['testimonial__ID']; ?>/"><i class="fa fa-edit"></i></a>
                                                    <?php } ?>

                                                    <?php if ($deleteAccess == TRUE) { ?>

                                                        <a onclick="return delById('card_<?php echo $row['testimonial__ID']; ?>', '<?php echo CONFIRM_DELETE; ?>')" href="<?php echo ADMIN_URL; ?>testimonials-remote/delete/<?php echo $row['testimonial__ID']; ?>/" target="remote"><i class="fa fa-trash"></i></a>
                                                    <?php } ?>
