...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" action="<?php echo ADMIN_SUBMIT_URL; ?>testimonials-remote/update/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" >
