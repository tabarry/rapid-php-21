                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                    ...
                                    <fieldset id="search-area1">
                                        ...
                                        <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
                                            ...
                                            <?php if (isset($_GET['q'])) { ?>
                                                ...
                                                <div class="pull-right"><a class="underline" href="<?php echo ADMIN_URL; ?>media-categories-cards/">Clear search.</a></div>
                                            <?php } ?>
                                        </div>
                                    </fieldset>
                                </form>
                                ...
                                <?php if ($addAccess == 'true') { ?>
                                    <div id="table-area"><a href="media-categories-add/" class="btn btn-black">Add new..</a></div>
                                ...
                                while ($row = suFetch($result)) {
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" id="card_<?php echo $row['mediacat__ID']; ?>">
                                        <div class="card">
                                            <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE)) { ?>
                                                ...
                                                <header>
                                                    <?php if ($editAccess == TRUE) { ?>
                                                        ...
                                                        <a href="<?php echo ADMIN_URL; ?>media-categories-update/<?php echo $row['mediacat__ID']; ?>/"><i class="fa fa-edit"></i></a>
                                                    <?php } ?>

                                                    <?php if ($deleteAccess == TRUE) { ?>

                                                        <a onclick="return delById('card_<?php echo $row['mediacat__ID']; ?>', '<?php echo CONFIRM_DELETE; ?>')" href="<?php echo ADMIN_URL; ?>media-categories-remote/delete/<?php echo $row['mediacat__ID']; ?>/" target="remote"><i class="fa fa-trash"></i></a>
                                                    <?php } ?>
                                            ...
                                            <label>Type</label>
                                            <p><?php
                                                if (suUnstrip($row['mediacat__Type']) == '') {
                                                    echo "-";
                                                } else {
                                                    echo suSubstr(suUnstrip($row['mediacat__Type']));
                                                }
                                                ?></p>
                                            <label>Sequence</label>
                                            <p><?php
                                                if (suUnstrip($row['mediacat__Sequence']) == '') {
                                                    echo "-";
                                                } else {
                                                    echo suSubstr(suUnstrip($row['mediacat__Sequence']));
                                                }
                                                ?></p>
                                ...
                                <?php if ($downloadAccessCSV == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>media-categories/stream-csv/" class="btn btn-black pull-right"><i class="fa fa-download"></i> Download CSV</a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
                                <?php if ($downloadAccessPDF == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>media-categories/stream-pdf/" class="btn btn-black pull-right"><i class="fa fa-file-pdf-o"></i> Download PDF</a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
                                <!--SU ENDS-->
