                        ...
                        <div class="page-content">
                            ...
                            <div class="single-head">
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo ADMIN_URL; ?>pages/"><i class="fa fa-table"></i></a>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div id="content-area">
                                    ...
                                    <fieldset id="search-area1">
                                        ...
                                        <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
                                            ...
                                            <?php if (isset($_GET['q'])) { ?>
                                                ...
                                                <div class="pull-right"><a class="underline" href="<?php echo ADMIN_URL; ?>pages-cards/">Clear search.</a></div>
                                            <?php } ?>
                                        </div>
                                    </fieldset>
                                </form>
                                ...
                                <?php if ($addAccess == 'true') { ?>
                                    <div id="table-area"><a href="<?php echo ADMIN_URL; ?>pages-add/" class="btn btn-black">Add new..</a></div>
                                <?php } ?>
                                <?php
                                ...
                                while ($row = suFetch($result)) {
                                    ?>
                                    <!-- CARDS START -->
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" id="card_<?php echo $row['page__ID']; ?>">
                                        <div class="card">
                                            <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE)) { ?>
                                                ...
                                                <header>
                                                    <?php if ($editAccess == TRUE) { ?>
                                                        ...
                                                        <a href="<?php echo ADMIN_URL; ?>pages-update/<?php echo $row['page__ID']; ?>/"><i class="fa fa-edit"></i></a>
                                                    <?php } ?>

                                                    <?php if ($deleteAccess == TRUE) { ?>

                                                        <a onclick="return delById('card_<?php echo $row['page__ID']; ?>', '<?php echo CONFIRM_DELETE; ?>')" href="<?php echo ADMIN_URL; ?>pages-remote/delete/<?php echo $row['page__ID']; ?>/" target="remote"><i class="fa fa-trash"></i></a>
                                                    <?php } ?>
                                            ...
                                            <label>Name</label>
                                            <h1><?php
                                                if (suUnstrip($row['page__Name']) == '') {
                                                    echo "-";
                                                } else {
                                                    echo suSubstr(suUnstrip($row['page__Name']));
                                                }
                                                ?></h1>
                                            ...
                                            <p><?php
                                                if (suUnstrip($row['page__Sequence']) == '') {
                                                    echo "-";
                                                } else {
                                                    echo suSubstr(suUnstrip($row['page__Sequence']));
                                                }
                                                ?></p>
                                ...
                                <?php if ($downloadAccessCSV == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>pages/stream-csv/" class="btn btn-black pull-right"><i class="fa fa-download"></i> Download CSV</a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
                                <?php if ($downloadAccessPDF == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>pages/stream-pdf/" class="btn btn-black pull-right"><i class="fa fa-file-pdf-o"></i> Download PDF</a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
                                <!--SU ENDS-->
